...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        predictive_alert_threshold=_env_float("AEGIS_PREDICTIVE_ALERT_THRESHOLD", 0.28),
        predictive_auto_action_threshold=_env_float("AEGIS_PREDICTIVE_AUTO_ACTION_THRESHOLD", 0.55),
